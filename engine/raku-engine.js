...
export const DLLS = [
  { name:'RakuCore', fns:3860, desc:'Runtime lifecycle, logging, telemetry, job system, timers, memory pools' },
  { name:'RakuScene', fns:2530, desc:'Scene graph, prefabs, CSG, GridMap, terrain, streaming' },
  { name:'RakuRenderer', fns:3675, desc:'PBR materials, dynamic lighting, shadows, particles, post-FX, LOD' },
  { name:'RakuXR', fns:2672, desc:'OpenXR 1.1, hand and eye tracking, spatial anchors, foveated rendering' },
  { name:'RakuPhysics', fns:1269, desc:'Rigid bodies, cloth, vehicles, ragdolls, fluid simulation, joints' },
  { name:'RakuAudio', fns:1653, desc:'Spatial 3D audio, HRTF, propagation, adaptive music, bus mixing' },
  { name:'RakuAnimation', fns:1895, desc:'Skeletal animation, blend trees, IK, root motion, state machines' },
  { name:'RakuAI', fns:740, desc:'Navmesh, behavior trees, NPC dialogue, utility AI, GOAP, crowd sim' },
  { name:'RakuSLM', fns:666, desc:'On-device LLM inference, emotion recognition, gesture detection' },
  { name:'RakuNetwork', fns:1359, desc:'Sessions, state sync, WebRTC, matchmaking, NAT traversal' },
  { name:'RakuVoice', fns:258, desc:'STT, TTS, VAD, opus codec, noise suppression' },
  { name:'RakuInput', fns:586, desc:'Actions, gamepad, XR controllers, gestures, haptic feedback' },
  { name:'RakuUI', fns:1147, desc:'Canvas, widgets, layouts, accessibility, HUD overlay' },
  { name:'RakuAssets', fns:1565, desc:'Mesh import, texture compression, audio codecs, hot reload' },
  { name:'RakuEditor', fns:1141, desc:'Gizmos, inspector, profiler, debug draw, scene tools' },
  { name:'RakuScripting', fns:3649, desc:'Lua VM, events, quests, dialogue trees, visual scripting' },
  { name:'RakuCSG', fns:61, desc:'Boolean geometry operations: union, subtract, intersect' },
  { name:'RakuGameplay', fns:2012, desc:'Game state machines, save/load, inventory, quests, achievements' },
];
