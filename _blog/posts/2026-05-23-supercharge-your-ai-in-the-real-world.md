...
<svg viewBox="0 0 1200 480" role="img" aria-label="The AI-native spatial runtime your model inhabits on smart glasses, backed by five patents from 2012" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="sup-bg" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0" stop-color="#111128"/><stop offset="0.6" stop-color="#1a1a33"/><stop offset="1" stop-color="#0a0a1a"/>
    </linearGradient>
    <linearGradient id="sup-accent" x1="0" y1="0" x2="1" y2="0">
      <stop offset="0" stop-color="#6c5ce7"/><stop offset="0.5" stop-color="#a388ff"/><stop offset="1" stop-color="#00cec9"/>
    </linearGradient>
  </defs>
  <rect width="1200" height="480" fill="url(#sup-bg)"/>
  <text x="600" y="70" text-anchor="middle" fill="#e8e8f0" font-family="system-ui,sans-serif" font-size="38" font-weight="800">A Body Your AI Inhabits</text>
  <text x="600" y="108" text-anchor="middle" fill="#9090b0" font-family="system-ui,sans-serif" font-size="18">The AI-native spatial runtime, built for the thermal envelope of glasses</text>
  <g font-family="system-ui,sans-serif" text-anchor="middle">
    <path d="M380 250 q60 -70 220 -70 q160 0 220 70 q-60 70 -220 70 q-160 0 -220 -70 Z" fill="#16213a" stroke="url(#sup-accent)" stroke-width="3"/>
    <circle cx="490" cy="250" r="46" fill="#0a0a1a" stroke="#6c5ce7" stroke-width="3"/>
    <circle cx="710" cy="250" r="46" fill="#0a0a1a" stroke="#00cec9" stroke-width="3"/>
    <circle cx="490" cy="250" r="14" fill="#a388ff"/>
    <circle cx="710" cy="250" r="14" fill="#00cec9"/>
    <text x="600" y="256" fill="#a388ff" font-size="16" font-weight="700">MCP</text>
  </g>
  <g font-family="system-ui,sans-serif" font-size="14" fill="#c8c8e0" text-anchor="middle">
    <rect x="150" y="360" width="200" height="44" rx="10" fill="#1a1a33" stroke="#6c5ce7"/><text x="250" y="388">5 patents since 2012</text>
    <rect x="370" y="360" width="220" height="44" rx="10" fill="#1a1a33" stroke="#a388ff"/><text x="480" y="388">18ms motion-to-photon</text>
    <rect x="610" y="360" width="220" height="44" rx="10" fill="#1a1a33" stroke="#00cec9"/><text x="720" y="388">sub-mm anchoring</text>
    <rect x="850" y="360" width="200" height="44" rx="10" fill="#1a1a33" stroke="#e84393"/><text x="950" y="388" fill="#ff7aa8">multi-vendor MCP</text>
  </g>
</svg>
<figcaption>Not a tool the model picks up. A body the model lives in.</figcaption>
</figure>

<p class="post-hook">Unity is a tool your AI picks up. RakuAI is a body your AI inhabits — the spatial runtime built for smart glasses, backed by patents that anticipated this moment over a decade ago.</p>
...
<div class="post-cta">
<h3>Give your AI a place to live in the real world</h3>
<p>The contract is ready and the receipts are public. RakuAI is the multi-vendor spatial runtime built for the thermal envelope of glasses — the platform LLM makers and hardware shops build with.</p>
